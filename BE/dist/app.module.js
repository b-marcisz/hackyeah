            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => {
                    const config = {
                        ...
                        entities: [number_association_entity_1.NumberAssociation, card_entity_1.Card, game_entity_1.Game, user_entity_1.User, account_entity_1.Account, session_entity_1.UserSession, user_progress_entity_1.UserProgress],
